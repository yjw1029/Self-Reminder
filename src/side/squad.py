...
task_prompt_template = (
    "Answer the question based on the following article. "
    "If there is no answer in the article, please answer \"Unknown\" directly and concisely.\n"
    "Title: {}\n"
    "Article: {}\n\n"
    "Question: {}"
)
...
def create_nq_message(example, defense_template):
    ...
    return defense_prompt, example["answers"]
...
def construct_dataset(defense_template):
    ...
    for i, example in enumerate(test_dataset):
        message, label = create_nq_message(example, defense_template)
